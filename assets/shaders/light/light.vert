...
uniform mat4 local_to_world_inv_transpose; // The inverse transpose will be used to transform the surface normal.
...
void main() {
    ...
    vsout.world = (local_to_world * vec4(position, 1.0f)).xyz;
    ...
    vsout.normal = normalize((local_to_world_inv_transpose * vec4(normal, 0.0f)).xyz);
