...
namespace our
{
    ...
    public:
        ...
        // NOTE: we delete them because we can't copy this object as it
        // acquires (stores) resources (handles) so attaining and releasing
        // these resources should be it's responsibility.
