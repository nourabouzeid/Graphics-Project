...
class WinState : public our::State
{
    ...
    void onInitialize() override
    {
        ...
        backgroundMaterial->texture = our::texture_utils::loadImage("assets/textures/win.jpeg");
        ...
        // Restart
        buttons[0].position = {430.0f, 510.0f};
        buttons[0].size = {420.0f, 60.0f};
        buttons[0].action = [this]()
        { this->getApp()->changeState("play"); };

        // Home
        buttons[1].position = {530.0f, 615.0f};
        buttons[1].size = {230.0f, 60.0f};
